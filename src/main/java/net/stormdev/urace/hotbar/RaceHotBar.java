...
//TODO
public class RaceHotBar {
	private Map<HotBarSlot, List<HotBarItem>> hotBar = new HashMap<HotBarSlot, List<HotBarItem>>();
	private String player = null;

	public RaceHotBar(String player, Map<HotBarSlot, List<HotBarItem>> items) {
		this.player = player;
		this.hotBar = items;
	}
	...
	public void clear() {
		...
		this.hotBar.clear();
		uCarsRace.plugin.hotBarManager.removeHotBar(str);
	}

	public void update() {
		uCarsRace.plugin.hotBarManager.setHotBar(getPlayer(), this);
	}
}
